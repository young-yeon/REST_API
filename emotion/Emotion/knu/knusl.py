# KNU 한국어 감성사전
# 작성자 : 온병원, 박상민, 나철원
# 소속 : 군산대학교 소프트웨어융합공학과 self.data Intelligence Lab
...
# 감정단어사전0603 데이터 출처 : http://self.datascience.khu.ac.kr/board/bbs/board.php?bo_table=05_01&wr_id=91 
...
class KnuSL():
	...
	def __init__(self):
		with open('emotion/Emotion/knu/data/SentiWord_info.json', encoding='utf-8-sig', mode='r') as f:
